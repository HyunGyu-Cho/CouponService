...
당시 스크립트는 HTTP 500과 네트워크 오류를 구분하지 않았으므로, 751건에는 V3 비교 실험(2026-09-15)의 1,000 VU 실행에서 확인된 로컬 HTTP 진입 구간의 TCP 연결 거절이 섞여 있을 수 있다. [V3 부하 테스트 결과](../v3/load-test-result.md) 참고.
